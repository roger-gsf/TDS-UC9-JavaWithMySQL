...
public class Exercise2 extends javax.swing.JFrame {
    ...
    public Exercise2() {
        ...
        // Adding an *ItemListener* to each selection button:
    ...
    private void btnShootActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnShootActionPerformed
        // Verify if none button is selected:
    ...
    // Function to generate the machine play that is a random number:
